...
extension ThemesViewController: ThemePlaceholderDelegate {
    func themePlaceholderDidTap(themeName: ThemeName) {
        ...
        /*
         ...
         1. Первые два случая вызывают retain cycles, однако он не гразит утечкой памяти,
            тк время жизни ThemesVC гарантитровано меньше чем ConversationVC (ConversationVC является рутовым контроллером навигации).
